...
execute as @a at @s if score @s _st_briefing matches 190 run tellraw @s ["",{"text":"[Chief Scientist Alex] ","color":"green"},{"text":"There's some kind of Sculk Warden on this world. They probably have some kind of Sculk lab or garden hidden deep underground.","color":"white"}]
