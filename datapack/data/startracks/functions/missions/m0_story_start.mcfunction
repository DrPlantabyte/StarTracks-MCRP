...
scoreboard objectives add _st_m27_guard2 minecraft.killed:minecraft.elder_guardian "Kill 3 Elder Guardians"
scoreboard objectives add _st_m30_nether2b minecraft.killed:minecraft.wither "Kill an AI Singularity"
scoreboard objectives add _st_m34_ender1d minecraft.killed:minecraft.ender_dragon "Slay the Dragon"