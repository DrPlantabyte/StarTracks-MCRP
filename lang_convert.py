...
def change(key, val):
	...
	text = text.replace('Sugar Cane','Silicane')
	text = text.replace('Sugar','Sweetener')
	...
	text = text.replace('Chicken','Plasma-Chook')
	text = text.replace('Feather','Plasma Nugget')
	...
	text = text.replace('%s Lapis Lazuli','%s Catalite Crystals')
	text = text.replace('Lapis Lazuli','Catalite Crystal')
	text = text.replace('Enchanted Book','Enhancement Kit')
	text = text.replace('Smooth Stone','Silicon Panel')
	text = text.replace('Disenchant','Reset')
	...
	text = text.replace(' book',' tablet')
	text = text.replace('Enchanting','Cybernetic')
	text = text.replace('Enchanted','Cybernetic')
	text = text.replace('Enchantment','Enhancement')
	text = text.replace('Enchant','Enhance')
	text = text.replace('Potion','Nanite Serum')
	text = text.replace('Painting','View Screen')
	text = text.replace(' enchantment',' enhancement')
	text = text.replace('Primed TNT','Overloaded Reactor')
	text = text.replace('TNT','Reactor')
	text = text.replace('Gunpowder','Di-Lithium')
	...
	text = text.replace('Sea Lantern','Star Light')
