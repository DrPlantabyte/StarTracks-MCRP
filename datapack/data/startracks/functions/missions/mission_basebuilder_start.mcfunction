...
## briefing
tellraw @a ["",{"text":"[Commander Steve] ","color":"blue"},{"text":"You call that dirt-hole a base? No! Make a proper base, with 100 stone bricks and a white cloning bed.","color":"white"}]
