...
execute as @a at @s if score @s _st_briefing matches 150 run tellraw @s ["",{"text":"[Chief Scientist Alex] ","color":"green"},{"text":"You should be able to, *ahem*, 'liberate' some from one of those fire-shooting netherspace probes","color":"white"}]
