...
execute as @a at @s if score @s _st_briefing matches 30 run tellraw @s ["",{"text":"[Chief Scientist Alex] ","color":"green"},{"text":"Interesting... These readings suggest that you may also find diamonds, cybernite, and redstone farther down in the subsurface.","color":"white"}]
